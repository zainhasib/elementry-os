...
// Processes 
PROCESS process[5]={{0,2,3,3,0,0,0,0,0}, {1,3,9,9,0,0,0,0,0}, {2,0,6,6,0,0,0,0,0}, {3,1,2,2,0,0,0,0,0}, {4,35,8,8,0,0,0,0,0}};
PROCESS io[5];
...
void incCounter() {
    int i=0;
    for(i=0;i<5;i++) {
        if(process[i].arrived && !process[i].complete) {
            process[i].timer++;
        }
    }
}
